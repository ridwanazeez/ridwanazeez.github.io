              ...
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <div class="relative">
                    ...
                    <input v-model="cif" type="number" name="cif" id="cif" placeholder="12000" class="pl-7 mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div>
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <div class="relative">
                    ...
                    <input v-model="exchange_rate" step=".1" type="number" name="exchange-rate" id="exchange-rate" placeholder="208.5" class="pl-7 mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div>
              </div>
              <div class="grid grid-cols-6 gap-6">
