	...
	<div class="h-full">
		<div class="h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
			<div class="shadow-xl rounded-xl">
				<div class="bg-cover bg-center mx-auto w-auto [height:200px] rounded-t-xl"
					style="background-image: url(/empty-wallet.jpg)" role="img" aria-label="Image of an empty wallet">
				</div>
				<div class="px-10 py-10">
					<form @submit.prevent="checkForm" class="max-w-md w-full space-y-8">
						<div>
							<h2 class="text-center text-3xl font-extrabold text-gray-900">Motor Vehicle Import Duty
								Calculator</h2>
							<p class="text-sm text-center">v1.2.0 | Last updated: 22/01/2023</p>
							<p class="mt-4 font-medium text-gray-500 text-center">Disclaimer: This website is in no way
								affiliated with the Guyana Revenue Authority (GRA). It is an independent calculator
								which uses the <a href="https://www.gra.gov.gy/imports/motor-vehicle/" class="underline">formulas set
									out by the GRA.</a> <br /></p>
							<div v-if="errors.length">
								<p class="mt-4 font-medium text-red-500 text-center text-2xl">Error! Please fill in all
									the fields!</p>
						...
						<div class="mt-4 space-y-6">
							<div class="grid grid-cols-6 gap-6">
								<div class="col-span-6 sm:col-span-3">
									...
									<input v-model="cif" type="number" name="cif" id="cif" placeholder="12000"
										class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
								</div>
								<div class="col-span-6 sm:col-span-3">
									<label for="exchange-rate" class="block text-sm font-medium text-gray-700">Exchange
										Rate (GYD to USD)</label>
									<input v-model="exchange_rate" step=".1" type="number" name="exchange-rate" id="exchange-rate"
										placeholder="208.5"
										class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
								</div>
							</div>
							<div class="grid grid-cols-6 gap-6">
								<div class="col-span-6 sm:col-span-3">
									<label for="vehicle-age" class="block text-sm font-medium text-gray-700">Age of
										Vehicle</label>
									<select v-model="age" id="vehicle-age" name="vehicle-age"
								...
								<div class="col-span-6 sm:col-span-3">
									...
									<select v-model="fuel" id="fuel" name="fuel"
										class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
							...
							<div v-if="this.fuel != 'Electric'">
								<div v-if="this.fuel == 'Gasoline'">
									...
									<select v-model="cc" id="cc" name="cc"
										class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
								...
								<div v-if="this.fuel != ''" class="mt-6">
									<label for="pickup" class="block text-sm font-medium text-gray-700">Is this vehicle
										a Pickup?</label>
									...
									<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
										...
										<table class="table-auto w-full">
											...
											<tr>
												...
												<td></td>
												<td class="text-right">{{
													"$ " + Math.round(total_tax).toLocaleString()
														+ " "
												}}GYD</td>
											</tr>
											<tr>
												...
												<td></td>
												<td class="text-right">{{
													"$ " + Math.round(total_cost).toLocaleString()
														+ " "
												}}GYD</td>
											</tr>
										</table>
